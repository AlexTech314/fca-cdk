    ...
    <footer className="border-t border-border bg-primary-dark text-white">
        ...
        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="lg:col-span-1">
            <Link href="/" className="inline-flex items-center gap-3">
              ...
              />
              <span className="text-lg font-semibold">Flatirons Capital</span>
            </Link>
            <p className="mt-4 text-sm text-gray-300">
              {siteConfig.tagline}
            </p>
            <p className="mt-4 text-sm text-gray-400">
              North American mergers and acquisitions advisory firm specializing
            ...
            <ul className="mt-4 space-y-3">
              ...
              <li className="pt-2">
                ...
                <p className="text-sm text-gray-400">
                  {siteConfig.locations.map((loc) => loc.city).join(' | ')}
                </p>
              </li>
              <li className="pt-2">
                <a
      ...
      <div className="border-t border-gray-700">
        <div className="container-max flex flex-col items-center justify-between gap-4 py-6 md:flex-row">
          <p className="text-sm text-gray-400">
            &copy; {getCurrentYear()} {siteConfig.name}, LLC. All rights
            reserved.
          </p>
