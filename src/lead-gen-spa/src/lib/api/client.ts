...
function transformLead(raw: any): Lead {
  ...
  return {
    ...
    qualityPercentileByType: raw.qualityPercentileByType ?? raw.quality_percentile_by_type ?? null,
    qualityPercentileByCity: raw.qualityPercentileByCity ?? raw.quality_percentile_by_city ?? null,
    exitPercentileByType: raw.exitPercentileByType ?? raw.exit_percentile_by_type ?? null,
    exitPercentileByCity: raw.exitPercentileByCity ?? raw.exit_percentile_by_city ?? null,
