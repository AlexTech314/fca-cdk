...
function transformLead(raw: any): Lead {
  ...
  return {
    ...
    sellPercentileByType: raw.sellPercentileByType ?? raw.sell_percentile_by_type ?? null,
    sellPercentileByCity: raw.sellPercentileByCity ?? raw.sell_percentile_by_city ?? null,
